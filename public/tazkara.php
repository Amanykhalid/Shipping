...
<body data-spy="scroll" data-target="#navbar-example">
  ...
  <header id="header" class="fixed-top">
    ...
    margin-right: -15%;">
           <li>
           <!-- style="display:inline;color:#fff" type="button" data-toggle="modal" data-target="#myModal" -->
             <a href="tazkara.html"  style="display:inline;color:#fff" ><i class="fa fa-user" aria-hidden="true"></i>
            Login</a>
            /
            <a href="tazkara.html" style="display:inline;color:#fff" type="button" ><i class="fa fa-ticket" aria-hidden="true"></i>
            Tazkara</a>  </li>
        </div>
      </nav><!-- .nav-menu -->
        ...
        <div class="container ">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:10%">
              <div class="section-headline text-center">
                <h2>Welcom <span style="color:#ed3c66">Ahemd osama</span> </h2>
              </div>
            </div>
          </div>
          <!-- <div class="row">
    ...
    <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="form contact-form">
                ...
                <a href="#" style="border: 1px solid #000;color: black;margin-top: 0;margin-left: 30%;disply:inline" class="ready-btn scrollto">Show all</a>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="form contact-form">
                ...
                <a href="#" style="border: 1px solid #000;color: black;margin-top: 0;margin-left: 30%;disply:inline" class="ready-btn scrollto">Create new</a>
