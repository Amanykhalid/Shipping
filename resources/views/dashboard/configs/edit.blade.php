        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item ">تعديل البيانات الاساسية<</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <div class="card-body col-7">
                    ...
                    <form class="form-horizontal" action="" method="post">
                      ...
                      <div class="form-group">
                        <label for="inputName" class="col-sm-2 control-label">اسم النظام</label>
                      ...
                      <div class="form-group">
                        <label for="inputEmail" class="col-sm-2 control-label">وصف النظام</label>
                      ...
                      <div class="form-group">
                        <label for="inputName" class="col-sm-2 control-label">البريد الالكتروني</label>

                        <div class="col-sm-10">
                          <input  type="text" name="email" value="test@gmail.com" class="form-control" id="inputName" >
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputSkills" class="col-sm-2 control-label">صورة النظام</label>
