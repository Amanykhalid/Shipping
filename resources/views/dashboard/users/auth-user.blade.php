...
<div class="content-wrapper" style="min-height: 205px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>جمع اعضاء UNDP</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin">الاداريين</a></li>
              <li class="breadcrumb-item active">جمع اعضاء undp</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
              <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 150.2px;">المكانة الادارية</th>
                ...
                <tr role="row" class="even">
                  <td class="sorting_1">احمد جهاد</td>
                  <td> adhmed@gamil.com</td>
                  <td>اداري</td>
