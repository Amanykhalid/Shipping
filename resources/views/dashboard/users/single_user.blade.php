          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">لمى عيسى</h3>

                <p class="text-muted text-center">المحافظة , المدينة</p>
                <p class="text-muted text-center">الجنس : انثى</p>
                ...
                <ul class="nav nav-pills">
                    <nav class="w-100">
                        <div class="nav nav-tabs" id="product-tab" role="tablist">
                            <a class="nav-item nav-link active " id="product-desc-tab" data-toggle="tab" href="#product-desc" role="tab" aria-controls="product-desc" aria-selected="true">بيانات المستخدم  </a>

                            <a class="nav-item nav-link" id="product-comments-tab" data-toggle="tab" href="#product-comments" role="tab" aria-controls="product-comments" aria-selected="false">التذاكر  </a>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        <label for="inputExperience" class="col-sm-2 control-label">تاريخ الميلاد</label>

                        <div class="col-sm-10">
                          <input value="17-1-1992" disabled class="form-control" id="inputName">
                        </div>
                      </div>
                      <div class="form-group">
