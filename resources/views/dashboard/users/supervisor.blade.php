        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin">المراقبين</a></li>
              <li class="breadcrumb-item active">عرض جميع المراقبين</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
              <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <tr role="row" class="even">
                  <td class="sorting_1">هادي خالد </td>
                ...
                <tr role="row" class="even">
                    <td class="sorting_1">جهان مسعود </td>
