        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">عرض جميع السلايدرات</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
              <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                      ...
                      <div class="col-sm-12 col-md-6">
                        ...
                        @endcan
                          ...
                          <div class="dataTables_length" id="example1_length"> 
                            ...
                            <thead>
                <tr role="row">
                    <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 201px;">عنوان السلادير </th>
                ...
                <tr role="row" class="even">
                  ...
                  <td> <img src="{{asset('images/'.$slider->image)}}" height="100px" width="100px" alt=""></td>
