        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">عرض جميع المستخدمين</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                  <div class="row">
                      ...
                      <div class="col-sm-12 col-md-6">
                        <a style="display: inline" href="/admin/users/create" class="btn btn-xs btn-primary">اضف مستخدم</a>
                ...
                <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 150.2px;"> اسم المستخدم</th>
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 150.2px;"> البريد الالكترونى</th>
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 130px;">  حالة المستخدم</th>
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 150.2px;"> نوع المستخدم</th>
                ...
                <tr role="row" class="even">
                  ...
                  <td class="sorting_1">
                    @foreach ($user->roles_name as $key => $value) 
                     {{ $value}}
                    @endforeach
                  </td>
                  ...
                  <td>
                    <div class="btn-group" role="group" aria-label="Basic example">
                      <a href="{{route('users.edit',$user->id)}}" class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">تعديل</a>
                     ...
                     @csrf
                      ...
                      <a href="{{route('users.status',$user->id)}}" class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">
                        @if($user ->status == 'مفعل')
                        الغاء تفعيل
                        @else
                         تفعيل
